...
public class CreateChroniclesCore {
    ...
    private void commonSetup(final FMLCommonSetupEvent event) {
        ...
        RibbitTradeModule.TRADES.put(RibbitProfessionModule.MERCHANT, new ItemListing[]{
                new ItemsForAmethysts(getQuarkItem("quark:indigo_corundum"), 64, 64, 2, 2, 16),
                new ItemsForAmethysts(getQuarkItem("quark:violet_corundum"), 64, 64, 2, 2, 16),
                new ItemsForAmethysts(getQuarkItem("quark:white_corundum"), 64, 64, 2, 2, 16),
                new ItemsForAmethysts(getQuarkItem("quark:black_corundum"), 64, 64, 2, 2, 16),
                new ItemsForAmethysts(getQuarkItem("quark:yellow_corundum"), 64, 64, 2, 2, 16),
        });
        RibbitTradeModule.TRADES.put(RibbitProfessionModule.FISHERMAN, new ItemListing[]{
                new ItemsForAmethysts(getQuarkItem("quark:red_corundum"), 64, 64, 2, 2, 16),
                new ItemsForAmethysts(getQuarkItem("quark:orange_corundum"), 64, 64, 2, 2, 16),
                new ItemsForAmethysts(getQuarkItem("quark:yellow_corundum"), 64, 64, 2, 2, 16),
                new ItemsForAmethysts(getQuarkItem("quark:green_corundum"), 64, 64, 2, 2, 16),
                new ItemsForAmethysts(getQuarkItem("quark:blue_corundum"), 64, 64, 2, 2, 16),
        });
    }
